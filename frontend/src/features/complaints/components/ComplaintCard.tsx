  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
        {complaint.images && complaint.images.length > 0 ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gray-50 dark:bg-gray-800">
            <span className="text-5xl text-gray-300 dark:text-gray-500">
              <svg
      ...
      <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-grow">
        ...
        {canManage && (
          <div className="flex flex-col sm:flex-row gap-2 mt-4 pt-4 border-t-2 border-gray-200 dark:border-gray-800">
            {!['Resolved', 'Closed'].includes(complaint.status) && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors text-xs font-medium"
              >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors text-xs font-medium"
            >
