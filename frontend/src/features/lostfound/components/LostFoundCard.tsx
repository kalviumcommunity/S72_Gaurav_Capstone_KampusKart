...
export const LostFoundCard: React.FC<LostFoundCardProps> = ({
  ...
  const canManage =
    token && currentUser && item.user && (currentUser._id === item.user._id || currentUser.isAdmin);

  return (
    <div
      className="bg-white dark:bg-gray-900 rounded-lg border-2 border-gray-200 dark:border-gray-700 overflow-hidden cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 transition-colors duration-200"
    ...
    >
            ...
            <span className="text-5xl text-gray-300 dark:text-gray-600">
              ...
              >
                <path
                  ...
                  d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-3A2.25 2.25 0 008.25 5.25V9m7.5 0v10.5A2.25 2.25 0 0113.5 21h-3a2.25 2.25 0 01-2.25-2.25V9m7.5 0H6.75m8.25 0H18m-12 0h2.25"
                />
              </svg>
            </span>
          </div>
      ...
      <div className="p-4 sm:p-5 md:p-6">
        ...
        {canManage && (
          <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t-2 border-gray-200 dark:border-gray-700">
            {!item.resolved && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors duration-200 text-xs font-medium min-w-0 min-h-touch"
              >
            ...
            {!item.resolved && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors duration-200 text-xs font-medium min-w-0 min-h-touch"
              >
