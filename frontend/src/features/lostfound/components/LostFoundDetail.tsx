    ...
    <div className="space-y-8 pb-4">
      ...
      <div className="space-y-6">
        <div>
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white dark:text-white leading-tight mb-2">
            {item.title}
          </h2>
          <div className="flex items-center text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm font-medium">
            <FiCalendar className="mr-2" />
            <span>Posted on {new Date(item.createdAt).toLocaleDateString()}</span>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl border-2 border-gray-100">
          <div className="space-y-4">
            <div className="flex items-start">
              <div className="mt-1 p-2 bg-white dark:bg-gray-900 rounded-lg border-2 border-gray-100 dark:border-gray-700 mr-3 text-[#00C6A7]">
                <FiMapPin />
              </div>
              <div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">
                  Date of {item.type === 'lost' ? 'Loss' : 'Finding'}
                </p>
                <p className="text-gray-900 dark:text-white font-bold">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-500 uppercase tracking-widest">
                  Contact Info
                </p>
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg bg-white dark:bg-gray-900 p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700">
            {item.description}
          </p>
        </div>
      </div>
