    ...
    <div className="space-y-8 pb-4">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        <div className="w-full lg:w-1/2 flex-shrink-0 min-w-0">
          {event.image?.url ? (
            <div
              className="relative aspect-video rounded-xl overflow-hidden border-2 border-gray-100 dark:border-gray-800 cursor-zoom-in group"
            ...
            <div className="aspect-video bg-gray-50 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-700">
              <FiCalendar className="w-12 h-12 text-gray-200 dark:text-gray-600 mb-2" />
        ...
        <div className="flex-grow space-y-6 min-w-0">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white leading-tight mb-3 break-words">
              {event.title}
            </h2>
          ...
          <div className="space-y-4">
            <div className="flex items-start text-gray-700 dark:text-gray-300 gap-3">
              <FiMapPin className="text-[#00C6A7] dark:text-teal-400 w-5 h-5 flex-shrink-0 mt-0.5" />
            ...
            {event.operatingHours && (
              <div className="flex items-center text-gray-700 dark:text-gray-300 gap-3">
                <FiClock className="text-[#00C6A7] dark:text-teal-400 w-5 h-5 flex-shrink-0" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
              <FiFileText className="text-[#00C6A7] dark:text-teal-400" /> Event Description
            </h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed bg-white dark:bg-gray-900 p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-800 whitespace-pre-wrap">
              {event.description}
            </p>
          </div>
          ...
          {(event.mapLocation?.building || event.mapLocation?.floor || event.mapLocation?.room) && (
            <div>
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
                <FiMapPin className="text-[#00C6A7] dark:text-teal-400" /> Precise Location
              </h3>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 grid grid-cols-1 gap-4">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
              <FiUser className="text-[#00C6A7] dark:text-teal-400" /> Contact Information
            </h3>
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 space-y-4">
              {event.contactInfo?.name && (
                <div className="flex items-center gap-3">
                  <FiUser className="text-gray-400 dark:text-gray-500" />
                  <div>
                    <p className="text-xs text-gray-400 dark:text-gray-500 uppercase font-bold tracking-widest">
                      Name
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#00C6A7] dark:text-teal-400 font-bold hover:underline"
                    >
                      {event.contactInfo.email}
                    </a>
                  </div>
              ...
              {!event.contactInfo?.name &&
                !event.contactInfo?.email &&
                !event.contactInfo?.phone && (
                  <p className="text-gray-400 dark:text-gray-500 italic text-center py-2">
          ...
          {isAdmin && (
            <div className="pt-6 border-t-2 border-gray-100 dark:border-gray-800 flex flex-wrap gap-4">
              <button
                onClick={() => onEdit?.(event)}
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-blue-600 dark:bg-blue-500 text-white rounded-xl font-bold hover:bg-blue-700 dark:hover:bg-blue-600 transition-all shadow-lg shadow-blue-100 dark:shadow-none"
              >
                <FiEdit2 /> Edit Event
              </button>
              <button
