        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-6 sm:mb-8">
            <Link to="/" className="flex items-center gap-2 sm:gap-3">
              ...
              />
              <span className="text-lg sm:text-xl font-extrabold text-black dark:text-white tracking-tight">
                KampusKart
              </span>
            </Link>
          </div>
          ...
          {/* Success */}
          {message && (
            <div className="mb-4 rounded-lg bg-green-50 dark:bg-green-950/30 border-2 border-green-200 dark:border-green-900 p-3">
