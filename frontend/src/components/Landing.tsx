...
const blobs = [
  // Top left yellow
  <svg key="blob1" className="absolute left-0 top-0 w-64 h-64 -z-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#FFB434" d="M44.8,-67.7C56.6,-60.2,62.7,-44.2,68.2,-28.7C73.7,-13.2,78.6,1.8,75.2,15.2C71.8,28.6,60.1,40.4,47.2,48.7C34.3,57,20.1,61.8,5.2,64.7C-9.7,67.6,-24.3,68.6,-36.2,62.2C-48.1,55.8,-57.3,42,-65.2,27.2C-73.1,12.4,-79.7,-3.4,-77.2,-17.2C-74.7,-31,-63.1,-42.8,-50.2,-50.7C-37.3,-58.6,-23.1,-62.6,-7.7,-66.1C7.7,-69.6,23.9,-72.5,44.8,-67.7Z" transform="translate(100 100)" /></svg>,
  // Top right pink
  <svg key="blob2" className="absolute right-0 top-10 w-64 h-64 -z-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#EB5CAF" d="M44.8,-67.7C56.6,-60.2,62.7,-44.2,68.2,-28.7C73.7,-13.2,78.6,1.8,75.2,15.2C71.8,28.6,60.1,40.4,47.2,48.7C34.3,57,20.1,61.8,5.2,64.7C-9.7,67.6,-24.3,68.6,-36.2,62.2C-48.1,55.8,-57.3,42,-65.2,27.2C-73.1,12.4,-79.7,-3.4,-77.2,-17.2C-74.7,-31,-63.1,-42.8,-50.2,-50.7C-37.3,-58.6,-23.1,-62.6,-7.7,-66.1C7.7,-69.6,23.9,-72.5,44.8,-67.7Z" transform="translate(100 100)" /></svg>,
  // Bottom left pink
  <svg key="blob3" className="absolute left-0 bottom-0 w-64 h-64 -z-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#EB5CAF" d="M44.8,-67.7C56.6,-60.2,62.7,-44.2,68.2,-28.7C73.7,-13.2,78.6,1.8,75.2,15.2C71.8,28.6,60.1,40.4,47.2,48.7C34.3,57,20.1,61.8,5.2,64.7C-9.7,67.6,-24.3,68.6,-36.2,62.2C-48.1,55.8,-57.3,42,-65.2,27.2C-73.1,12.4,-79.7,-3.4,-77.2,-17.2C-74.7,-31,-63.1,-42.8,-50.2,-50.7C-37.3,-58.6,-23.1,-62.6,-7.7,-66.1C7.7,-69.6,23.9,-72.5,44.8,-67.7Z" transform="translate(100 100)" /></svg>,
  // Bottom right teal
  <svg key="blob4" className="absolute right-0 bottom-0 w-64 h-64 -z-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#34A853" d="M44.8,-67.7C56.6,-60.2,62.7,-44.2,68.2,-28.7C73.7,-13.2,78.6,1.8,75.2,15.2C71.8,28.6,60.1,40.4,47.2,48.7C34.3,57,20.1,61.8,5.2,64.7C-9.7,67.6,-24.3,68.6,-36.2,62.2C-48.1,55.8,-57.3,42,-65.2,27.2C-73.1,12.4,-79.7,-3.4,-77.2,-17.2C-74.7,-31,-63.1,-42.8,-50.2,-50.7C-37.3,-58.6,-23.1,-62.6,-7.7,-66.1C7.7,-69.6,23.9,-72.5,44.8,-67.7Z" transform="translate(100 100)" /></svg>
];
    ...
    <div className="relative min-h-screen bg-white font-sans overflow-hidden pt-24">
      ...
      <footer className="text-center py-8 text-gray-400 text-sm">
        ...
        <div className="flex justify-center gap-6 mb-4">
          {socials.map((s, i) => (
            <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} className="text-gray-400 hover:text-deep-purple-500 transition-colors duration-200">
              {s.icon}
            </a>
          ))}
        </div>
        <div className="flex justify-center gap-6 mb-2">
          <Link to="/about" className="text-body hover:underline">About</Link>
          <Link to="/privacy" className="text-body hover:underline">Privacy</Link>
          <Link to="/terms" className="text-body hover:underline">Terms</Link>
