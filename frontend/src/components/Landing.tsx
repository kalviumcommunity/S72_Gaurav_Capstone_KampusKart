...
const features = [
  {
    ...
    icon: <FiMap className="w-6 h-6 sm:w-7 sm:h-7" />,
    iconBg: 'bg-[#181818]',
  },
  {
    name: 'Lost & Found',
  ...
  },
  {
    ...
    icon: <FiCalendar className="w-6 h-6 sm:w-7 sm:h-7" />,
    iconBg: 'bg-[#00C6A7]',
  },
  {
    name: 'News',
    description: 'Read the latest campus news.',
    icon: <FiFileText className="w-6 h-6 sm:w-7 sm:h-7" />,
    iconBg: 'bg-[#181818]',
  },
  {
    name: 'Complaints',
    description: 'Raise and track campus complaints.',
    icon: <FiAlertCircle className="w-6 h-6 sm:w-7 sm:h-7" />,
    iconBg: 'bg-[#F05A25]',
  },
  {
    name: 'Facilities',
    description: 'Discover campus facilities and services.',
    icon: <FiHome className="w-6 h-6 sm:w-7 sm:h-7" />,
    iconBg: 'bg-[#00C6A7]',
  },
  {
    name: 'Global Chat',
...
const steps = [
  {
    ...
    desc: 'Browse all the smart tools KampusKart offers for your campus life.',
  },
  {
    iconBg: 'bg-[#00C6A7]',
    number: '2',
    title: 'Sign Up Instantly',
    desc: 'Create your account in seconds and personalize your experience.',
  },
  {
    iconBg: 'bg-[#F05A25]',
    number: '3',
    title: 'Enjoy Campus Life',
    desc: 'Access everything you need, stay updated, and connect with your campus.',
  },
];
    ...
    <div className="bg-white dark:bg-gray-950 font-sans pt-[72px]">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="mb-6 sm:mb-8 md:mb-10 text-center md:text-left">
          <span className="inline-flex items-center gap-2 mb-3 sm:mb-4 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 text-xs font-semibold text-teal-700 uppercase tracking-widest">
            Everything you need
          </span>
          <h2
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-black dark:text-white mb-2 sm:mb-3"
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
          {features.map((feature) => (
            ...
            >
              <div
                className={`mb-3 md:mb-4 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 flex items-center justify-center rounded-lg text-white ${feature.iconBg} transition-transform duration-200 group-hover:scale-110`}
              >
                {feature.icon}
              </div>
        ...
        {selectedFeature && (
          <div className="mt-5 rounded-lg border-2 border-[#00C6A7] bg-[#E6FFFA] dark:bg-gray-900 p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <p className="text-xs font-semibold text-[#00856F] dark:text-[#00C6A7] uppercase tracking-wider mb-1">
                Preview selected
              </p>
              <h3 className="text-base sm:text-lg font-extrabold text-[#005F52]">
                {selectedFeature.name}
              </h3>
              <p className="text-sm text-[#00685A] dark:text-gray-400">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link
                to="/signup"
                className="inline-flex items-center justify-center min-h-[44px] px-4 rounded-lg font-semibold text-[#005F52] dark:text-white bg-white dark:bg-gray-900 border-2 border-[#00C6A7] hover:bg-[#F3FFFC] dark:hover:bg-gray-800 transition-colors duration-200"
              >
                Create account
              </Link>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="mb-6 sm:mb-8 md:mb-10 text-center md:text-left">
          ...
          <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="p-4 sm:p-5 md:p-6 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 rounded-lg hover:shadow-md hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-200 group"
            >
              <div
                className={`mb-3 md:mb-4 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 flex items-center justify-center rounded-lg font-extrabold text-lg sm:text-xl text-white ${step.iconBg}`}
              >
                {step.number}
              </div>
              <h3 className="text-sm sm:text-base font-extrabold text-black dark:text-white mb-1 sm:mb-2">
                {step.title}
              </h3>
